#ifndef LowPtElectrons_LowPtElectrons_PassThroughTrackSeeds_H
#define LowPtElectrons_LowPtElectrons_PassThroughTrackSeeds_H
...
\date January 2007
 ...
 PassThroughTrackSeeds is the base class
...
class PassThroughTrackSeeds final : public edm::stream::EDProducer<edm::GlobalCache<goodseedhelpers::HeavyObjectCache> > {
  typedef TrajectoryStateOnSurface TSOS;
 public:
  explicit PassThroughTrackSeeds(const edm::ParameterSet&, const goodseedhelpers::HeavyObjectCache*);
