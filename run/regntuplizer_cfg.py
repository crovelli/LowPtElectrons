...
output_file = '/afs/cern.ch/work/c/cavalari/output_fromAOD_slim.root' if options.useAOD else '/afs/cern.ch/work/c/cavalari/regrrootuple_BJPsi.root'
...
process.load('LowPtElectrons.LowPtElectrons.RegSlimNtuplizer_cfi')
