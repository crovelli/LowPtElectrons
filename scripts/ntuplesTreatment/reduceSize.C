#define reduceSize_cxx
#include "reduceSize.h"
...
void reduceSize::train() {

  const char *origfname = "/tmp/crovelli/BuToKJpsiToee_UL18_AOD__prescale0d30.root";
  ...
  TDirectory *dir = (TDirectory*)origInput->Get("/tmp/crovelli/BuToKJpsiToee_UL18_AOD__prescale0d30.root:/ntuplizer");
  TTree *fChain ; 
  ...
  fChain->SetBranchAddress("gen_p", &gen_p);
  fChain->SetBranchAddress("gsf_p", &gsf_p);
  fChain->SetBranchAddress("gsf_pt", &gsf_pt);
  fChain->SetBranchAddress("gsf_bdtout2", &gsf_bdtout2);
  fChain->SetBranchAddress("gsf_mode_pt", &gsf_mode_pt);
  fChain->SetBranchAddress("gsf_eta", &gsf_eta);
  fChain->SetBranchAddress("gsf_phi", &gsf_phi);
  fChain->SetBranchAddress("gsf_mode_eta", &gsf_mode_eta);
  fChain->SetBranchAddress("gsf_mode_phi", &gsf_mode_phi);
  fChain->SetBranchAddress("trk_p", &trk_p);
  ...
  fChain->SetBranchAddress("ele_phi", &ele_phi);
  ...
  fChain->SetBranchAddress("eid_gsf_mode_p", &eid_gsf_mode_p);
  fChain->SetBranchAddress("eid_core_shFracHits", &eid_core_shFracHits);
  fChain->SetBranchAddress("eid_gsf_bdtout1", &eid_gsf_bdtout1);
  fChain->SetBranchAddress("eid_gsf_dr", &eid_gsf_dr);
  fChain->SetBranchAddress("eid_trk_dr", &eid_trk_dr);
  fChain->SetBranchAddress("eid_sc_Nclus", &eid_sc_Nclus);
  fChain->SetBranchAddress("eid_sc_clus1_nxtal", &eid_sc_clus1_nxtal);
  fChain->SetBranchAddress("eid_sc_clus1_dphi", &eid_sc_clus1_dphi);
  fChain->SetBranchAddress("eid_sc_clus2_dphi", &eid_sc_clus2_dphi);
  fChain->SetBranchAddress("eid_sc_clus1_deta", &eid_sc_clus1_deta);
  fChain->SetBranchAddress("eid_sc_clus2_deta", &eid_sc_clus2_deta);
  fChain->SetBranchAddress("eid_sc_clus1_E", &eid_sc_clus1_E);
  fChain->SetBranchAddress("eid_sc_clus2_E", &eid_sc_clus2_E);
  fChain->SetBranchAddress("eid_sc_clus1_E_ov_p", &eid_sc_clus1_E_ov_p);
  fChain->SetBranchAddress("eid_sc_clus2_E_ov_p", &eid_sc_clus2_E_ov_p);
  ...
  // New tree
  TFile *fileNew = TFile::Open("/tmp/reducedTree.root","RECREATE");     
  fileNew->ls();
  fileNew->cd();
  TDirectory *myDir = (TDirectory*)fileNew->mkdir("ntuplizer");
  myDir->cd();
  TTree *simu = new TTree("tree", "Reduced tree");  
  ...
  simu->Branch("eid_gsf_mode_p", &eid_gsf_mode_p, "eid_gsf_mode_p/f");
  simu->Branch("eid_core_shFracHits", &eid_core_shFracHits, "eid_core_shFracHits/f");
  simu->Branch("eid_gsf_bdtout1", &eid_gsf_bdtout1, "eid_gsf_bdtout1/f");
  simu->Branch("eid_gsf_dr", &eid_gsf_dr, "eid_gsf_dr/f");
  simu->Branch("eid_trk_dr", &eid_trk_dr, "eid_trk_dr/f");
  simu->Branch("eid_sc_Nclus",&eid_sc_Nclus,"eid_sc_Nclus/f");
  simu->Branch("eid_sc_clus1_nxtal",&eid_sc_clus1_nxtal,"eid_sc_clus1_nxtal/f");
  simu->Branch("eid_sc_clus1_dphi",  &eid_sc_clus1_dphi,  "eid_sc_clus1_dphi/f");
  simu->Branch("eid_sc_clus2_dphi",  &eid_sc_clus2_dphi,  "eid_sc_clus2_dphi/f");
  simu->Branch("eid_sc_clus1_deta",  &eid_sc_clus1_deta,  "eid_sc_clus1_deta/f");
  simu->Branch("eid_sc_clus2_deta",  &eid_sc_clus2_deta,  "eid_sc_clus2_deta/f");
  simu->Branch("eid_sc_clus1_E",     &eid_sc_clus1_E,     "eid_sc_clus1_E/f");
  simu->Branch("eid_sc_clus2_E",     &eid_sc_clus2_E,     "eid_sc_clus2_E/f");
  simu->Branch("eid_sc_clus1_E_ov_p",     &eid_sc_clus1_E_ov_p,     "eid_sc_clus1_E_ov_p/f");
  simu->Branch("eid_sc_clus2_E_ov_p",     &eid_sc_clus2_E_ov_p,     "eid_sc_clus2_E_ov_p/f");
  ...
  for (int i = 0; i < nloop; i++) {
    ...
    // 1 round
    // if (evt>900000000) continue;   // 2016
    // if (evt>950000000) continue;   // 2017
    // if (evt>980000000) continue;   // 2018
    //
    // 2 round
    // if (evt>470000000) continue;   // 2016
    // if (evt>520000000) continue;   // 2017
    if (evt>530000000) continue;   // 2018
