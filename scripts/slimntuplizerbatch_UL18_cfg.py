...
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         ...
         tag = cms.string("lowPtElectron_eb_ecalOnly_05To50_mean_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")),
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         label = cms.untracked.string("lowPtElectron_ee_ecalOnly_05To50_mean"),
         tag = cms.string("lowPtElectron_ee_ecalOnly_05To50_mean_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")),
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         label = cms.untracked.string("lowPtElectron_eb_ecalOnly_05To50_sigma"),
         tag = cms.string("lowPtElectron_eb_ecalOnly_05To50_sigma_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")),
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         label = cms.untracked.string("lowPtElectron_ee_ecalOnly_05To50_sigma"),
         tag = cms.string("lowPtElectron_ee_ecalOnly_05To50_sigma_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")),
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         label = cms.untracked.string("lowPtElectron_eb_ecalTrk_05To50_mean"),
         tag = cms.string("lowPtElectron_eb_ecalTrk_05To50_mean_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")),
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         label = cms.untracked.string("lowPtElectron_ee_ecalTrk_05To50_mean"),
         tag = cms.string("lowPtElectron_ee_ecalTrk_05To50_mean_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")),
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         label = cms.untracked.string("lowPtElectron_eb_ecalTrk_05To50_sigma"),
         tag = cms.string("lowPtElectron_eb_ecalTrk_05To50_sigma_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")),
cms.PSet(record = cms.string("GBRDWrapperRcd"),
         label = cms.untracked.string("lowPtElectron_ee_ecalTrk_05To50_sigma"),
         tag = cms.string("lowPtElectron_ee_ecalTrk_05To50_sigma_2018UL"),
         connect = cms.string("sqlite_file:/afs/cern.ch/user/c/crovelli/public/lowpt_reg/lowPtEleReg_2018UL_25112020.db")))
